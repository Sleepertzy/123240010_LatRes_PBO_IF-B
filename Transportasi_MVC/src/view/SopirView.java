...
public class SopirView extends JFrame {
    ...
    public SopirView() {
        ...
        JLabel title = new JLabel("Tabel Data Sopir");
        ...
        btnTambah.setBounds(150, 390, 90, 30);

        add(btnTambah);

        btnEdit = new JButton("Edit");

        btnEdit.setBounds(260, 390, 90, 30);

        add(btnEdit);

        btnHapus = new JButton("Hapus");

        btnHapus.setBounds(370, 390, 90, 30);

        add(btnHapus);

        btnMenu = new JButton("Kembali ke Menu");

        btnMenu.setBounds(480, 390, 150, 30);
        ...
        SopirController controller =
                new SopirController(this);
